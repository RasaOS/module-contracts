...
> **Who you are (SA-025).** `rasa.module.contracts` — the RasaOS module for contracts. Substrate: **RasaOS**; role: **module**. On install `bin/init` renders this into `.claude/rasa-identity.md`; `/whoami` composes the full identity with the project's deployment layer.
